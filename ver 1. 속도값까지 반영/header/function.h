...
void transpose(double matin[], double matout[], int row, int col); //matin과 matout이 같은 주소를 가져야 정확한 결과 나옴. 다른 주소인 경우 error. -> Cnb는 eulrdcmtr()로 구함
